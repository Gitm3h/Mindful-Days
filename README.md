...
1. index.html: Defines the structure of the single-page application, containing the header nav, layouts for both tabs, the item editor modal, and nature soundscape audio nodes.
